...
!function (t) {
    ...
    var i = {
        ...
        return _inherits(s, Component), _createClass(s, [{
            ...
            key: "_animateIn", value: function () {
                var i = this;
                t.extend(this.el.style, {display: "block"}), t.extend(this.$overlay[0].style, {display: "block"}), e({
            ...
            key: "_animateOut", value: function () {
                var i = this;
                e({targets: this.$overlay[0], duration: this.options.outDuration, easing: "easeOutQuart"});
                var n = {
                    targets: this.el,
                    duration: this.options.outDuration,
                    easing: "easeOutCubic",
                ...
                this.el.classList.contains("bottom-sheet") ? (t.extend(n, {bottom: "-100%"}), e(n)) : (t.extend(n, {
    ...
    var i = {
        ...
        return _inherits(s, Component), _createClass(s, [{
            ...
            key: "open", value: function () {
                ...
                }), this.attrWidth = this.$el.attr("width"), this.attrHeight = this.$el.attr("height"), this.attrWidth && (this.$el.css("width", this.attrWidth + "px"), this.$el.removeAttr("width")), this.attrHeight && (this.$el.css("width", this.attrHeight + "px"), this.$el.removeAttr("height")), this.$overlay = t('<div id="materialbox-overlay"></div>').css({}).one("click", function () {
    ...
    var i = {
        ...
        return _createClass(n, [{
            ...
            key: "dismiss", value: function () {
                ...
                this.wasSwiped && (this.el.style.transition = "transform .05s, opacity .05s", this.el.style.transform = "translateX(" + i + "px)", this.el.style), e({
                    targets: this.el,
                    marginTop: -40,
                    duration: this.options.outDuration,
                    easing: "easeOutExpo",
    ...
    var i = {indicators: !0, height: 400, duration: 500, interval: 6e3}, n = function (n) {
        ...
        return _inherits(s, Component), _createClass(s, [{
            ...
            key: "_animateCaptionIn", value: function (i, n) {
                var s = {targets: i, duration: n, easing: "easeOutQuad"};
                    ...
                    this.$active.removeClass("active"), e({
                        ...
                        complete: function () {
                            i.$slides.not(".active").each(function (t) {
                                e({targets: t, translateX: 0, translateY: 0, duration: 0, easing: "easeOutQuad"})
                            })
                        }
